...
function LoginCtrl($scope, $http, $templateCache){
    ...
    $scope.login = function(){
    	var url = 'http://localhost:6060/login?email=jonathannael12@gmail.com';// URL where the Node.js server is running	
...
function UserListCtrl($scope, $http, $templateCache) {
  ...
  $scope.list = function() {
	  var url = 'http://localhost:6060/getangularusers';// URL where the Node.js server is running	
